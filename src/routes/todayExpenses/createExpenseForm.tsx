    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    <Popover open={categoryDropdownOpen} onOpenChange={setCategoryDropdownOpen}>
                        <PopoverTrigger asChild>
                            <FormControl>
                                <Button
                                    ...
                                    {field.value
                                        ? (data.expenseCategories as Category[]).find(
                        ...
                        <PopoverContent className="p-0">
                            ...
                            <CommandList>
                                {(data.expenseCategories as Category[]).map((category) => (
                                    <CommandItem
                ...
                />
                <Button variant={'outline'} className='hover:bg-primary hover:text-primary-foreground transition-colors duration-300' type="submit">Confirm</Button>
            </form>
        </Form>
    );
}
